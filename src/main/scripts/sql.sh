...
download org.beangle.jdbc beangle-jdbc $beangle_jdbc_ver

jarfile="$M2_REPO/org/beangle/jdbc/beangle-jdbc/$beangle_jdbc_ver/beangle-jdbc-$beangle_jdbc_ver.jar"
